...
const Profile = () => {
    ...
    return (
        <section className="col-span-6 pt-4 pb-8 border-l border-r border-blue-50">
            <Header title={'Coder of the night'} icon={icon} />
            <div className="mb-4 aspect-w-16 aspect-h-5">
                <img src="./img/ada.png" alt="profile" className="w-full" />
            </div>
            <div className="flex flex-col">
                    ...
                    <div className="relative w-10 h-10">
                        <div className="absolute bottom-0 flex items-center justify-center w-32 h-32 rounded-full bg-gradient-to-tr from-indigo-400 to-red-600">
                            <div className="flex items-center bg-white rounded-full w-30 h-30">
                                <div className="relative mx-auto overflow-hidden rounded-full h-28 w-28">
                                    <img src="./img/safe.jpg" alt="pro" className="w-full h-full rounded-full" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex items-center gap-2 px-4">
                    <div className="text-2xl font-bold text-gray-900"> State Moon </div>
                    {icon}
                </div>
                {/* id */}
                <span className="block px-4 mb-4 text-base font-normal text-gray-600"> @spacemoon </span>
                {/* bio */}
                <p className="block px-4 mb-2 text-base font-normal text-gray-600">
                    SafeMoon - Auto-generating liquidity protocol / Static farming by holding!
                </p>
                ...
                <div className="flex items-center gap-4 px-4 mb-4 text-base font-normal">
                    ...
                    <div className="flex items-center gap-1 text-gray-600">
                        ...
                        {/* location */}
                        <span className="text-blue-400 "> safemoon.net </span>
                    </div>
                    {/* date */}
                    <div className="flex items-center gap-1 text-gray-600">
                        {/* logo */}
                        ...
                        {/* location */}
                        <span className=""> Joined March 2020 </span>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-6 px-4 mb-8">
                    ...
                    {/* followers */}
                    <div className="flex items-center gap-2">
                        <span className="block text-base font-bold text-gray-900"> 3852K </span>
